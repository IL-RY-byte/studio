...
export default function LoginPage() {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            toast({ title: 'Success!', description: 'You have been successfully signed in with Google.' });
            router.push('/admin/dashboard');
        } catch (error: any) {
             console.error(error);
            ...
            <main className="flex-1 flex items-center justify-center bg-muted/20 p-4">
                <Card className="w-full max-w-md">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            {isSignUp ? 'Enter your details to create a new admin account.' : 'Enter your credentials to access the admin panel.'}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
